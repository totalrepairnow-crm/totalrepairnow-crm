...
echo "[2/3] Escribiendo ClientDetail.jsx (Datos → Servicios → Fotos)"
cat > "$FILE" <<'EOF'
...
echo "OK. Hard refresh en el navegador (Ctrl+F5/Cmd+Shift+R). Orden aplicado: Datos → Servicios → Fotos, y título con empresa."
