...
FILES=(
  ...
  "$FRONT/src/pages/ClientEdit.jsx"
)

echo "[1/4] Backup de ClientDetail.jsx y ClientEdit.jsx"
for f in "${FILES[@]}"; do
  if [ -f "$f" ]; then
...
echo "[2/4] Reescribiendo ClientDetail.jsx con normalización de URLs"
...
echo "[3/4] Reescribiendo ClientEdit.jsx con normalización de URLs"
...
echo "[OK] Arreglo aplicado. Haz hard refresh (Ctrl+F5 o Cmd+Shift+R)."
